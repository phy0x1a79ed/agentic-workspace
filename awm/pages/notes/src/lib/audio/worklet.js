...
// posts ~20ms frames back to the main thread. Nearest-neighbor
// resampling is good enough for whisper. (Copied from the stt-composer
// worklet — the notes page drives its own dictation transport rather than
// reusing the composer UI, but the mic capture format is identical.)
