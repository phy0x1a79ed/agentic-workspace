...
def _default_context(project: str, scope: str) -> str:
    ...
    return (
        f"# {project}/{scope}\n\n"
        f"## Startup\n\n"
        f"1. Run `scope(verb=\"refresh\", args={{project:\"{project}\", scope:\"{scope}\"}})` to update local history and artifact indexes\n"
...
def _generate_artifacts_md(project: str, scope: str) -> str:
    ...
    return (
        f"<!-- AUTO-GENERATED by AWM. Do NOT edit this file directly.\n"
        f"     Refresh: `scope(verb=\"refresh\", args={{project:\"{project}\", scope:\"{scope}\"}})` -->\n\n"
        f"# Artifacts — {project}\n\n"
