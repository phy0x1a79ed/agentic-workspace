#!/usr/bin/env bash
# Canonical install for the awm-rlm-factorio service (editable, into the `awm` env).
#
...
run "$WS/awm/services/rlm-factorio"
...
echo "Installed awm-rlm-factorio into env '$ENV'."
