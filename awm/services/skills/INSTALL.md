# Installing the `skills` service

A Python feature service in the `awm.skills` namespace. It needs the `awm`
...
`awm dev shadow awm/services/skills`; it execs this same `run.sh` as an overlay.
