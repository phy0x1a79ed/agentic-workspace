#!/usr/bin/env bash
# Canonical install for the awm-orchestrator service (editable, into the `awm` env).
#
...
run "$WS/awm/services/orchestrator"
...
echo "Installed awm-orchestrator into env '$ENV'."
