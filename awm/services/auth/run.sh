#!/usr/bin/env bash
# run.sh — self-contained entry point for the auth service (credential authority).
#
...
# those, POSTs /hub/service/register, and holds the control WS open. No auth on
# the loopback registration handshake.
#
