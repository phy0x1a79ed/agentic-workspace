#!/usr/bin/env bash
# Canonical install for the awm-notifications service (editable, into the `awm` env).
#
...
run "$WS/awm/services/notifications"
...
echo "Installed awm-notifications into env '$ENV'."
