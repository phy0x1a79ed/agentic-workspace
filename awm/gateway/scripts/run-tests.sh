...
declare -A DISTS=(
  ...
  [notifications]="$WS/awm/services/notifications::$WS/awm/services/notifications/tests"
...
# Stable run order.
ORDER=(gateway agentcore gatewayclient telemetry scopes workspace agents artifacts writing events notifications social 2fa rlm-browser orchestrator graphify stt tts fileviewer notes)
