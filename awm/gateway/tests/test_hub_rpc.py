"""Unit tests for awm.gateway.hub.rpc.ControlChannel.
...
from awm.gateway.hub.rpc import (
    Bridge,
    ControlChannel,
    RpcError,
    _channels,
...
class TestSingletonTable:
    def test_ensure_control_is_idempotent(self):
        from awm.gateway.hub.rpc import ensure_control, get_control
    ...
    def test_drop_control_closes_channel(self):
        from awm.gateway.hub.rpc import drop_control, ensure_control, get_control
